...
/tool fetch url="{{config.hs_login_url}}" mode=$mode dst-path="flash/lomtech-hotspot/login.html"
/tool fetch url="{{config.hs_rlogin_url}}" mode=$mode dst-path="flash/lomtech-hotspot/rlogin.html"
